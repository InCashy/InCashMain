...
export const metadata = {
    ...
    description: "Read In Cashy’s Terms and Conditions to understand your rights, responsibilities, and the rules governing the use of our trucking factoring platform.",
};
